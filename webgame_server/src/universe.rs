...
pub struct UniverseState<'gs, GameStateType: GameState<GamePlayerStateT, GameStateSnapshotT>, GamePlayerStateT: PlayerState, GameStateSnapshotT: GameStateSnapshot, PlayEventT> {
...
pub struct Universe<'gs, GameStateType: GameState<GamePlayerStateT, GameStateSnapshotT>, GamePlayerStateT: PlayerState, GameStateSnapshotT: GameStateSnapshot, PlayEventT> {
    state: Arc<RwLock<UniverseState<'gs, GameStateType, GamePlayerStateT, GameStateSnapshotT, PlayEventT>>>,
}

impl<'gs, 'g, GameStateType: Default+GameState<GamePlayerStateT, GameStateSnapshotT>, GamePlayerStateT: PlayerState, GameStateSnapshotT:GameStateSnapshot, PlayEventT:Serialize+Send> Universe<'gs, GameStateType, GamePlayerStateT, GameStateSnapshotT, PlayEventT> {
